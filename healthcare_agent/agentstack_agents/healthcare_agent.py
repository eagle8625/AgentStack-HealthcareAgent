...
async def healthcare_concierge(
    ...
    agent = RequirementAgent(
        ...
        requirements=[ConditionalRequirement(think_tool, force_at_step=1),
                      ConditionalRequirement(policy_handoff, min_invocations=0, max_invocations=1),
                      ConditionalRequirement(research_handoff, min_invocations=0, max_invocations=1),
                      ConditionalRequirement(provider_handoff, min_invocations=0, max_invocations=1),
                      ],
